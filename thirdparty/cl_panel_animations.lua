-- https://github.com/NebulousCloud/helix/blob/ff41fe48126b891b6484acc3622dee83cf18e824/gamemode/core/libs/sh_animation.lua
-- Creates easy animations.

local function InstallAnimationMethods(meta)
...
InstallAnimationMethods(panelMeta)
