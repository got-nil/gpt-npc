...
function PANEL:Init()
    ...
    desc:SetText(string.Interpolate("I, {NAME}, hereby acknowledge that by clicking \"I Agree\" or accessing and using the services, I have read and fully understand the terms of service, including all terms and conditions, policies, guidelines, and any other relevant information provided by the company. I consent to be bound by these terms and agree to comply with all applicable laws and regulations. If I do not agree with any of these terms, I will not use the services. My continued use of the services after the effective date of any modifications to the terms constitutes my acceptance of such modifications.", {NAME = LocalPlayer():Name()}))
    ...
    accept.DoClick = function()
        ...
        -- Actually send the TOS accept message
        GNIL.GPT.TOS.Accept()
